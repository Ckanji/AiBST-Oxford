...
```{r}
set.seed(1)
x_set.seeed <- rnorm(n=1000, mean=10, sd=5)
...
```{r}
hist(x_set.seeed, breaks = 20)
abline(v=mean(x_set.seeed), col="red")
abline(v=median(x_set.seeed), col="red", lty="dashed")
abline(v=mean(x_set.seeed)-sd(x_set.seeed), col="blue")
abline(v=median(x_set.seeed)- mad(x_set.seeed), col="blue", lty="dashed")
abline(v=median(x_set.seeed)+mad(x_set.seeed), col="blue", lty="dashed")
...
```{r}
set.seed(1)
xx_set.seeed <- rnorm(n=1000000, mean=10, sd=5)
hist(xx_set.seeed, breaks = 1000)
abline(v=mean(xx_set.seeed), col="red")
abline(v=median(xx_set.seeed), col="red", lty="dashed")
abline(v=mean(xx_set.seeed)-sd(xx_set.seeed), col="blue")
abline(v=median(xx_set.seeed)- mad(xx_set.seeed), col="blue", lty="dashed")
abline(v=median(xx_set.seeed)+mad(xx_set.seeed), col="blue", lty="dashed")
...
```{r}
xy_wilk_output <- wilcox.test(x = 1:10, y = 5:14)
xy_wilk_output
str(xy_wilk_output)
xy_wilk_output$p.value
```
...
```{r}
logcounts_matrix <- read_excel("GSE111543.xlsx","logcounts")
logcounts_matrix
...
print(t_test_row(index = 1,  logcounts_matrix, cell_info))
print(t_test_row(index = 2,  logcounts_matrix, cell_info))
print(t_test_row(index = 50,  logcounts_matrix, cell_info))
print(t_test_row(index = 330,  logcounts_matrix, cell_info))
